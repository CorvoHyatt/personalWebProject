...
class TipoProfesorController {
    ...
    listOne(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const respuesta = yield database_1.default.query('SELECT * FROM tipoprofesor WHERE idTipoProfesor=?', [id]);
    ...
    create(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const resp = yield database_1.default.query('INSERT INTO tipoProfesor SET ?', [req.body]);
            res.json(resp);
        });
    }
    delete(req, res) {
